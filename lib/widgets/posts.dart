import 'dart:async';
//import 'dart:html';
import 'package:app_red_social/pages/Notifications_page.dart';
import 'package:app_red_social/pages/comments.dart';
 ...
 handleDeletePost(BuildContext parentContext){
  ...
  deletePost()async{
    postsRef
      ...
      //then delete all activity feednotification
   ...
   return GestureDetector(
     ...
     child: Stack(
       ...
       children: <Widget>[
         ...
         //showHeart ? Icon(Icons.favorite, size: 120.0, color:Colors.red): Text(''),
        showHeart ?Animator(
